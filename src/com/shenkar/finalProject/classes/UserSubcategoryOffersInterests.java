...
@Entity
@Table (name="UserOffersInterests")
public class UserSubcategoryOffersInterests {
	...
	public UserSubcategoryOffersInterests() {}

	public UserSubcategoryOffersInterests(int userId, int homeWorks, int testStudy, int practice, int ride, int shopping,
