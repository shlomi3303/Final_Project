...
public class ManualMatchOffer extends Match {
	...
	public ManualMatchOffer() {}

	public ManualMatchOffer(int applicationID, boolean offerAproved, boolean applicationAproved, int userId) 
	{
