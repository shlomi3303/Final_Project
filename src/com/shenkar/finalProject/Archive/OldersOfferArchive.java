...
@Entity
@Table (name="Archive_OfferOlders")
public class OldersOfferArchive extends Offer
{
	...
	public OldersOfferArchive() {super();}

	public OldersOfferArchive(int userId, Date period, String location, Date periodic, boolean urgency,
