...
@Entity
@Table (name="Archive_ApplicationsOlders")
public class OldersApplicationArchive extends Application 
{
	...
	public OldersApplicationArchive() {
		super();
	}


	public OldersApplicationArchive(int userId, Date period, String location, Date periodic, boolean urgency,
