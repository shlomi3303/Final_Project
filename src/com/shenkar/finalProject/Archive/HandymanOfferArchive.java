...
@Entity
@Table (name="Archive_OfferHandyman")
public class HandymanOfferArchive extends Offer
{
	...
	public HandymanOfferArchive() {super();}

	public HandymanOfferArchive(int userId, Date period, String location, Date periodic, boolean urgency,
