...
@Entity
@Table (name="Archive_ApplicationStudent")
public class StudentApplicationArchive extends Application 
{
	...
	public StudentApplicationArchive() {super();}

	public StudentApplicationArchive(int userId, Date period, String location, Date periodic, boolean urgency,
